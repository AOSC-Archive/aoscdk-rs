...
struct InstallConfig {
    ...
    install_rescuekit: Arc<AtomicBoolWrapper>,
}
...
impl Default for InstallConfig {
    fn default() -> Self {
        InstallConfig {
            ...
            install_rescuekit:  Arc::new(AtomicBoolWrapper { v: AtomicBool::new(false) }),
        }
    }
}
...
fn begin_install(
    ...
    let (main_part, _) = if config.install_rescuekit.v.load(Ordering::SeqCst) {
